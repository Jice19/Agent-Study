聚焦于 AI Agent 开发全流程，从核心思想、技术原理到工程实践，系统梳理了 Agent 分类、RAG（检索增强生成）、Multi-Agent、LangChain/LangGraph 等关键技术，同时包含大模型认知、向量检索、工程化部署等实战内容，是 AI Agent/RAG 领域从入门到实战的一站式参考手册。
核心内容结构
1. Agent 核心基础
